#!/usr/bin/env sh
# Universal installer for licenselens. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/licenselens.git"
echo "Installing licenselens ..."
...
echo "Done. Run: licenselens --help"
