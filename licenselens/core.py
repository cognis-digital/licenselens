"""LICENSELENS core — Dependency license + SBOM gate, developer-CLI first."""
...
RULES = [
    ("LIC-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("LIC-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("LIC-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
