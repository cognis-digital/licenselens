...
[![PyPI](https://img.shields.io/pypi/v/cognis-licenselens.svg)](https://pypi.org/project/cognis-licenselens/)
[![CI](https://github.com/cognis-digital/licenselens/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/licenselens/actions)
...
LICENSELENS exists for one job — dependency license + sbom gate, developer-cli first — and does it without a SaaS bill or heavyweight setup.
...
```bash
licenselens --version
licenselens scan .                      # scan the current project
licenselens scan . --format json
licenselens scan . --fail-on high       # non-zero exit for CI gates
licenselens mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **FOSSA**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`licenselens` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
